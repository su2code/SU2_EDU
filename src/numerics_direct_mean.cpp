...
void CUpwTurkel_Flow::ComputeResidual(double *val_residual, double **val_Jacobian_i, double **val_Jacobian_j, CConfig *config) {
  ...
  sqr_one_m_Betasqr_Lam1 = (one_m_Betasqr*Lambda[0])*(one_m_Betasqr*Lambda[0]); // [(1-Beta^2)*Lambda[0]]^2
  sqr_two_Beta_c_Area    = (2.0*Beta*RoeSoundSpeed*Area)*(2.0*Beta*RoeSoundSpeed*Area); // [2*Beta*c*Area]^2
