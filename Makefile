...
ACLOCAL = ${SHELL} /Users/fpalacios/SU2_EDU/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /Users/fpalacios/SU2_EDU/missing --run tar
...
AUTOMAKE = ${SHELL} /Users/fpalacios/SU2_EDU/missing --run automake-1.9
AWK = awk
CPPFLAGS = 
CXX = g++
...
CXXFLAGS =  -DNO_MPI -O3
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"SU2_EDU\" -DPACKAGE_TARNAME=\"SU2_EDU\" -DPACKAGE_VERSION=\"1.1.0\" -DPACKAGE_STRING=\"SU2_EDU\ 1.1.0\" -DPACKAGE_BUGREPORT=\"susquared-dev@lists.stanford.edu\" -DPACKAGE=\"SU2_EDU\" -DVERSION=\"1.1.0\" 
DEPDIR = .deps
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
infodir = ${prefix}/info
install_sh = /Users/fpalacios/SU2_EDU/install-sh
...
bin/SU2_EDU$(EXEEXT): $(bin_SU2_EDU_OBJECTS) $(bin_SU2_EDU_DEPENDENCIES) bin/$(am__dirstamp)
	...
	$(CXXLINK) $(bin_SU2_EDU_LDFLAGS) $(bin_SU2_EDU_OBJECTS) $(bin_SU2_EDU_LDADD) $(LIBS)
