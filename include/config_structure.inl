...
inline void CConfig::SetKind_Linear_Solver(unsigned short val_kind_linear_solver) { Kind_Linear_Solver = val_kind_linear_solver; }
...
inline void CConfig::SetLinear_Solver_Iter(unsigned long val_linear_solver_iter) { Linear_Solver_Iter = val_linear_solver_iter; }
